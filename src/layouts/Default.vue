<template>
  <div class="content-wrapper splash font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>        
          <g-link to="/" @click.native="scrollToTop">
            <div class="text-4xl font-bold leading-tight whitespace-nowrap hover:text-black"><g-image src="../../static/vp-icon.png" class="w-14 object-left" alt="logo" style="float:left;" /><div class="h-12 pl-16">Vanessa Pashkoff</div></div>
          </g-link>
        </div>
        ...
        >
          ...
          <li>
            <a href="mailto:vpashkoff@gmail.com" class="text-black-700 hover:text-purple-800">
              <font-awesome :icon="['far', 'envelope']" size='2x'/>
            </a>
          </li> 
          <li>
            <a href="https://instagram.com/provocations_at_home/" target="_blank" class="text-black-700 hover:text-purple-800">
    ...
    <footer class="bg-purple-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          ...
          <div>
            <a href="/rss.xml" class="text-white hover:text-gray-400 font-normal">RSS Feed</a> |  <a href="/sitemap.xml" class="text-white hover:text-gray-400 font-normal">Sitemap</a>
          </div>        
      </div>
    </footer>
